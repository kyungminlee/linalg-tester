/* cgesv.cpp -- LAPACK CGESV/ZGESV accuracy tester (complex general linear solve AX = B) */
                ...
                const TestParams &params, const std::string &format)
{
    ...
    /* Generate random complex n-by-n matrix A */
    ...
    /* Call CGESV/ZGESV: void xGESV(int *n, int *nrhs, T *A, int *lda, int *ipiv,
    ...
    report_lapack_result("CGESV", params_str, lr, format);
