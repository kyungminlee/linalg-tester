/* swap.cpp -- Mirror tester for BLAS Level 1 SWAP */
...
/* Fortran ABI: void swap(n, x, incx, y, incy) */
                       ...
                       const TestParams &params, const MirrorConfig &config)
{
    ...
    /* After swap, x should contain original y and y should contain original x.
       Compare both x and y outputs between sides. */
    auto run_side = [&](const MirrorSide &side,
        ...
        auto *fn = reinterpret_cast<swap_fn_t>(
    ...
    mirror_report_result("SWAP", params_str, err, nullptr, nullptr, config);
}
