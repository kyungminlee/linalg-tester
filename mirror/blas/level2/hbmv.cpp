/* hbmv.cpp -- Mirror tester for BLAS Level 2 HBMV (complex-only) */
                       ...
                       const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        auto run_side = [&](const MirrorSide &side, MpfrComplexMatrix &result) {
            void *native_AB    = mpfr_complex_mat_to_native(AB_mpfr, ldab, side.ctx);
            ...
            auto *fn = reinterpret_cast<hbmv_fn_t>(
        ...
        mirror_report_result("HBMV", params_str, err,
