/* hpr.cpp -- Mirror tester for BLAS Level 2 HPR (complex-only) */
                      ...
                      const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        MpfrScalar alpha_mpfr(prec);  /* alpha is REAL for HPR */
        ...
        auto run_side = [&](const MirrorSide &side, MpfrComplexMatrix &result) {
            ...
            auto *fn = reinterpret_cast<hpr_fn_t>(
        ...
        std::snprintf(params_str, sizeof(params_str),
                      "uplo=%c n=%d incx=%d",
                      uplo, n, incx);
        mirror_report_result("HPR", params_str, err,
