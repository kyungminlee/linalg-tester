/* sbmv.cpp -- Mirror tester for BLAS Level 2 SBMV */
                       ...
                       const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        gen_mpfr_symmetric_band_matrix(AB_mpfr, n, k, uplo, prec, &seed_AB);
        ...
        auto run_side = [&](const MirrorSide &side, MpfrMatrix &result) {
            ...
            auto *fn = reinterpret_cast<sbmv_fn_t>(
        ...
        std::snprintf(params_str, sizeof(params_str),
                      "uplo=%c n=%d k=%d incx=%d incy=%d",
                      uplo, n, k, incx, incy);
        mirror_report_result("SBMV", params_str, err,
