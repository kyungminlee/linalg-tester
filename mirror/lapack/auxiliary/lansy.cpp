/* lansy.cpp -- Mirror tester for LAPACK LANSY (symmetric matrix norm) */
...
void mirror_test_lansy(const MirrorSide &a, const MirrorSide &b,
                        const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        for (char norm_type : {'M', '1', 'I', 'F'}) {
            ...
            mirror_report_result("LANSY", params_str, err,
