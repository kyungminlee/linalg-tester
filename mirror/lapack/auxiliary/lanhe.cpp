/* lanhe.cpp -- Mirror tester for LAPACK LANHE (Hermitian matrix norm) */
...
void mirror_test_lanhe(const MirrorSide &a, const MirrorSide &b,
                        const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        for (char norm_type : {'M', '1', 'I', 'F'}) {
            ...
            mirror_report_result("LANHE", params_str, err,
