/* heevd.cpp -- Mirror tester for LAPACK HEEVD (hermitian eigenvalues, D&C) */
...
void mirror_test_heevd(const MirrorSide &a, const MirrorSide &b,
                        const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        auto run_side = [&](const MirrorSide &s, MpfrMatrix &W_out) {
            ...
            auto *fn = reinterpret_cast<heevd_fn_t>(
            ...
            /* rwork query: read real part from rwork_buf */
        ...
        std::snprintf(params_str, sizeof(params_str),
                      "uplo=%c n=%d", uplo, n);
        mirror_report_result("HEEVD", params_str, err,
