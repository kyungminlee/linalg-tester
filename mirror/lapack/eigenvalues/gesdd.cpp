/* gesdd.cpp -- Mirror tester for LAPACK GESDD (SVD, divide & conquer) */
...
void mirror_test_gesdd(const MirrorSide &a, const MirrorSide &b,
                        const TestParams &params, const MirrorConfig &config)
{
    ...
    auto run_side = [&](const MirrorSide &s, MpfrMatrix &S_out) {
        ...
        auto *fn = reinterpret_cast<gesdd_fn_t>(
        ...
        fn(&"N"[0], &m, &n, native_A, &lda, S,
           ...
           work_buf, &lwork_query, iwork, &info,
           (std::size_t)1);
    ...
    mirror_report_result("GESDD", params_str, err,
