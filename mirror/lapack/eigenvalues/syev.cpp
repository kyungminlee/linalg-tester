/* syev.cpp -- Mirror tester for LAPACK SYEV (symmetric eigenvalues, QR) */
...
void mirror_test_syev(const MirrorSide &a, const MirrorSide &b,
                       const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        /* Generate symmetric matrix in MPFR */
        ...
        auto run_side = [&](const MirrorSide &s, MpfrMatrix &W_out) {
            ...
            auto *fn = reinterpret_cast<syev_fn_t>(
            ...
            /* Re-materialize A (destroyed by query) */
            std::free(native_A);
        ...
        std::snprintf(params_str, sizeof(params_str),
                      "uplo=%c n=%d", uplo, n);
        mirror_report_result("SYEV", params_str, err,
