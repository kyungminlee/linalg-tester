/* hetrf.cpp -- Mirror tester for LAPACK HETRF (hermitian indefinite factorization) */
...
extern "C" typedef void (*hetrf_fn_t)(
    const char *uplo, const int *n, void *A, const int *lda,
    int *ipiv, void *work, const int *lwork, int *info,
    std::size_t uplo_len);

void mirror_test_hetrf(const MirrorSide &a, const MirrorSide &b,
                        const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        auto run_side = [&](const MirrorSide &side,
            ...
            auto *fn = reinterpret_cast<hetrf_fn_t>(
        ...
        std::snprintf(params_str, sizeof(params_str),
                      ...
                      ipiv_match ? "yes" : "NO");
        mirror_report_result("HETRF", params_str, err,
