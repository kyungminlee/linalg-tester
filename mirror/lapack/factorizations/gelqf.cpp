/* gelqf.cpp -- Mirror tester for LAPACK GELQF (LQ factorization) */
...
extern "C" typedef void (*gelqf_fn_t)(
    const int *m, const int *n, void *A, const int *lda,
    void *tau, void *work, const int *lwork, int *info);

void mirror_test_gelqf(const MirrorSide &a, const MirrorSide &b,
                        const TestParams &params, const MirrorConfig &config)
{
    ...
    auto run_side = [&](const MirrorSide &side, MpfrMatrix &result,
        ...
        auto *fn = reinterpret_cast<gelqf_fn_t>(
    ...
    mirror_report_result("GELQF", params_str, err,
