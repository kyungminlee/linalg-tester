/* posv.cpp -- Mirror tester for LAPACK POSV (positive definite solve) */

#include "../mirror_lapack_common.h"

extern "C" typedef void (*posv_fn_t)(
...
void mirror_test_posv(const MirrorSide &a, const MirrorSide &b,
                       const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        auto run_side = [&](const MirrorSide &s, MpfrMatrix &result) {
            ...
            auto *fn = reinterpret_cast<posv_fn_t>(
        ...
        mirror_report_result("POSV", params_str, err,
