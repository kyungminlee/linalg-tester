/* csysv.cpp -- Mirror tester for LAPACK CSYSV/ZSYSV (complex symmetric indefinite solve) */

#include "../mirror_lapack_common.h"

extern "C" typedef void (*csysv_fn_t)(
...
void mirror_test_csysv(const MirrorSide &a, const MirrorSide &b,
                        const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        auto run_side = [&](const MirrorSide &s, MpfrComplexMatrix &result) {
            auto *fn = reinterpret_cast<csysv_fn_t>(
        ...
        mirror_report_result("CSYSV", params_str, err,
