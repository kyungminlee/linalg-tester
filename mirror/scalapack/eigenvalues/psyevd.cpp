/* psyevd.cpp -- Mirror tester for ScaLAPACK PSYEVD (distributed symmetric eigenvalues, D&C) */
...
void mirror_test_psyevd(const MirrorSide &a, const MirrorSide &b,
                          const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        auto run_side = [&](const MirrorSide &s, MpfrMatrix &W_out) {
            ...
            auto *fn = reinterpret_cast<psyevd_fn_t>(
            ...
            fn(&"V"[0], &uplo, &n,
               ...
               work_buf, &lwork_query, &iwork_buf, &liwork_query,
               &info,
        ...
        std::snprintf(params_str, sizeof(params_str),
                      "uplo=%c n=%d", uplo, n);
        mirror_report_result("PSYEVD", params_str, err,
