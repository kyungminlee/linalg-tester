/* cpgeqrf.cpp -- Mirror tester for ScaLAPACK complex PGEQRF (distributed QR factorization) */
...
void mirror_test_cpgeqrf(const MirrorSide &a, const MirrorSide &b,
                           const TestParams &params, const MirrorConfig &config)
{
    ...
    auto run_side = [&](const MirrorSide &side, MpfrComplexMatrix &result) {
        ...
        std::free(A_loc);
        A_loc = scatter_mpfr_complex_to_local(A_mpfr, m, n, lld_a, mpc, side.ctx);
        ...
        gather_local_complex_to_mpfr(result, A_loc, lld_a, m, n, mpc, side.ctx);
    ...
    mirror_report_result("CPGEQRF", ps, err, nullptr, nullptr, config);
}
