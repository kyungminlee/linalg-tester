/* cppotrf.cpp -- Mirror tester for ScaLAPACK complex PPOTRF (distributed Cholesky factorization) */
...
void mirror_test_cppotrf(const MirrorSide &a, const MirrorSide &b,
                          const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        mirror_report_result("CPPOTRF", ps, err, nullptr, nullptr, config);
    }
}
