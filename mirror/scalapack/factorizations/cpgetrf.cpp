/* cpgetrf.cpp -- Mirror tester for ScaLAPACK complex PGETRF (distributed LU factorization) */
...
void mirror_test_cpgetrf(const MirrorSide &a, const MirrorSide &b,
                          const TestParams &params, const MirrorConfig &config)
{
    ...
    mirror_report_result("CPGETRF", ps, err, nullptr, nullptr, config);
}
