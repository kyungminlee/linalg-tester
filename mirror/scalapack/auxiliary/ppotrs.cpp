/* ppotrs.cpp -- Mirror tester for ScaLAPACK PPOTRS (distributed Cholesky solve) */
...
void mirror_test_ppotrs(const MirrorSide &a, const MirrorSide &b,
                         const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        mirror_report_result("PPOTRS", ps, err, nullptr, nullptr, config);
    }
}
