/* cpgetrs.cpp -- Mirror tester for ScaLAPACK complex PGETRS (distributed LU solve) */
...
void mirror_test_cpgetrs(const MirrorSide &a, const MirrorSide &b,
                          const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char trans : {'N', 'T'}) {
        ...
        mirror_report_result("CPGETRS", ps, err, nullptr, nullptr, config);
    }
}
