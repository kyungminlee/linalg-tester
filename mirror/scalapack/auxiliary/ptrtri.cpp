/* ptrtri.cpp -- Mirror tester for ScaLAPACK PTRTRI (distributed triangular inverse) */
...
void mirror_test_ptrtri(const MirrorSide &a, const MirrorSide &b,
                         const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        mirror_report_result("PTRTRI", ps, err, nullptr, nullptr, config);
    }
}
