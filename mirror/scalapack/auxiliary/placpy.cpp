/* placpy.cpp -- Mirror tester for ScaLAPACK PLACPY (distributed matrix copy) */
...
void mirror_test_placpy(const MirrorSide &a, const MirrorSide &b,
                         const TestParams &params, const MirrorConfig &config)
{
    ...
    auto run_side = [&](const MirrorSide &side, MpfrMatrix &result) {
        ...
        gather_local_to_mpfr(result, B_loc, lld_b, m, n, mpc, side.ctx);
    ...
    mirror_report_result("PLACPY", "uplo=A", err, nullptr, nullptr, config);
}
