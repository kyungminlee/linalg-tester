/* pposv.cpp -- Mirror tester for ScaLAPACK PPOSV (distributed SPD solve) */
...
void mirror_test_pposv(const MirrorSide &a, const MirrorSide &b,
                        const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        mirror_report_result("PPOSV", ps, err, nullptr, nullptr, config);
    }
}
