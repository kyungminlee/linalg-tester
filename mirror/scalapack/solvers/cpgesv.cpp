/* cpgesv.cpp -- Mirror tester for ScaLAPACK complex PGESV (distributed general solve) */
...
void mirror_test_cpgesv(const MirrorSide &a, const MirrorSide &b,
                         const TestParams &params, const MirrorConfig &config)
{
    ...
    mirror_report_result("CPGESV", ps, err, nullptr, nullptr, config);
}
