/* pdotu.cpp -- Mirror tester for PBLAS Level 1 PDOTU (complex unconjugated dot) */
...
void mirror_test_pdotu(const MirrorSide &a, const MirrorSide &b,
                         const TestParams &params, const MirrorConfig &config)
{
    ...
    auto run_side = [&](const MirrorSide &s, MpfrComplexScalar &result) {
        ...
        int one = 1;
        auto *fn = reinterpret_cast<pdotu_fn_t>(
    ...
    mirror_report_result("PDOTU", ps, err, nullptr, nullptr, config);
}
