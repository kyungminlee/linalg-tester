/* psyr2.cpp -- Mirror tester for PBLAS Level 2 PSYR2 (symmetric rank-2) */
...
void mirror_test_psyr2(const MirrorSide &a, const MirrorSide &b,
                         const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char uplo : {'U', 'L'}) {
        ...
        auto run_side = [&](const MirrorSide &s, MpfrMatrix &result) {
            ...
            int one = 1;
            auto *fn = reinterpret_cast<psyr2_fn_t>(
        ...
        mirror_report_result("PSYR2", ps, err, nullptr, nullptr, config);
    }
}
