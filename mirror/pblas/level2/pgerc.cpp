/* pgerc.cpp -- Mirror tester for PBLAS Level 2 PGERC (complex conjugated rank-1) */
...
void mirror_test_pgerc(const MirrorSide &a, const MirrorSide &b,
                         const TestParams &params, const MirrorConfig &config)
{
    ...
    auto run_side = [&](const MirrorSide &s, MpfrComplexMatrix &result) {
        ...
        int one = 1;
        auto *fn = reinterpret_cast<pgerc_fn_t>(
    ...
    mirror_report_result("PGERC", ps, err, nullptr, nullptr, config);
}
