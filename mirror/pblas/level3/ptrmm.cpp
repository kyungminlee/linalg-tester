/* ptrmm.cpp -- Mirror tester for PBLAS Level 3 PTRMM */
...
void mirror_test_ptrmm(const MirrorSide &a, const MirrorSide &b,
                         const TestParams &params, const MirrorConfig &config)
{
    ...
    for (char diag : {'N', 'U'}) {
        ...
        auto run_side = [&](const MirrorSide &s, MpfrMatrix &result) {
            ...
            int one = 1;
            auto *fn = reinterpret_cast<ptrmm_fn_t>(
        ...
        mirror_report_result("PTRMM", ps, err, nullptr, nullptr, config);
    }}}}
}
